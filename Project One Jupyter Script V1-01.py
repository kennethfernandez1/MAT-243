...
your_team_df = your_years_leagues_df[(your_years_leagues_df['fran_id']=='Spurs')]
...
print("Choice 1 =", round(choice1,2))
print("Choice 2 =", round(choice2,2))
print("\n")
print("The correct choice is: ", round(choice2,2))
...
probability_less_skill = st.norm.cdf(mean_elo_assigned_team, mean, stdev)

print("Probability that a team has Average Relative Skill LESS than the Bulls in the years 1996 to 1998 = ", round(probability_less_skill,2))
